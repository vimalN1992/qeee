...
class VideoIndex extends Component {
  static navigationOptions = ({ navigation }) => { 
        ...
        header.headerLeft = <TouchableHighlight
            ...
            onPress={() =>  { 
                if(navigation.state.routeName == 'videoMain'){
    ...
    handleBackButtonClick() {  
      ...
      if(this.props.navigation.state.routeName == 'videoMain'){
 ...
 _renderRow(rowData, s, i) {
    return (   
        ...
        onPress={  () => {
            if(this.props.navigation.state.routeName == 'videoMain'){
              return this.props.navigation.navigate('BS7Main', { data:rowData, cdata: this.props.navigation.state.params.data });  
            }else{
              return this.props.navigation.navigate('BS7', { data:rowData, cdata: this.props.navigation.state.params.data });
            }
        }}
        />
      );
