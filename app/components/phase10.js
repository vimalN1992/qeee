...
handleBackButtonClick() {
 ...
 renderRow(rowData, sectionID) {   
  ...
  render() {
    const items = this.props.phasecourseslist[10];
    ...
    this.state = {
      dataSource: ds.cloneWithRows(_.values(this.props.phasecourseslist[10])),
    };
...
export default connect(mapStateToProps, { getAllPhaseCourses, selectBook })(Phase10);